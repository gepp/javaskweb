...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">发票卷明细添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqFpjmxForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqFpjmx.id" placeholder="请输入ID"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqFpjmx.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>发票编码<b></b></label>
 			   <input  type="text" class="dfinput" id="fpbm" name="skqFpjmx.fpbm" placeholder="请输入发票编码"  />
 			   </li>
 				       			 			   <li><label>发票编码<b></b></label>
 			   <input  type="text" class="dfinput" id="fpdm" name="skqFpjmx.fpdm" placeholder="请输入发票编码"  />
 			   </li>
 				       			 			   <li><label>发票起始号<b></b></label>
 			   <input  type="text" class="dfinput" id="fpqsh" name="skqFpjmx.fpqsh" placeholder="请输入发票起始号"  />
 			   </li>
 				       			 			   <li><label>发票截止号<b></b></label>
 			   <input  type="text" class="dfinput" id="fpjzh" name="skqFpjmx.fpjzh" placeholder="请输入发票截止号"  />
 			   </li>
 				       			 			   <li><label>发票单位<b></b></label>
 			   <input  type="text" class="dfinput" id="fpdw" name="skqFpjmx.fpdw" placeholder="请输入发票单位"  />
 			   </li>
 				       			 			   <li><label>机器编号<b></b></label>
 			   <input  type="text" class="dfinput" id="jqbh" name="skqFpjmx.jqbh" placeholder="请输入机器编号"  />
 			   </li>
 				       			 			   <li><label>发票下发状态<b></b></label>
 			   <input  type="text" class="dfinput" id="fpxfzt" name="skqFpjmx.fpxfzt" placeholder="请输入发票下发状态"  />
 			   </li>
 				       			 			   <li><label>发票领购状态<b></b></label>
 			   <input  type="text" class="dfinput" id="fplgzt" name="skqFpjmx.fplgzt" placeholder="请输入发票领购状态"  />
 			   </li>
 				       			 			   <li><label>明细上传状态<b></b></label>
 			   <input  type="text" class="dfinput" id="mxsczt" name="skqFpjmx.mxsczt" placeholder="请输入明细上传状态"  />
 			   </li>
 				       			 			   <li><label>发票领购日期<b></b></label>
 			   <input  type="text" class="dfinput" id="fplgrq" name="skqFpjmx.fplgrq" placeholder="请输入发票领购日期"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqfpjmx/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
