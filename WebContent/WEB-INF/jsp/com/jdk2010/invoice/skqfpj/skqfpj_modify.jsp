...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">发票卷信息编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="post"  id="skqFpjForm">
 			   ...
 			   <input  type="text" class="dfinput" id="fpbm" name="skqFpj.fpbm" placeholder="请输入发票编码" value="${ skqFpj.fpbm}" />
 			   </li>
 				       			 			   <li><label>发票编码<b></b></label>
 			   <input  type="text" class="dfinput" id="fpdm" name="skqFpj.fpdm" placeholder="请输入发票编码" value="${ skqFpj.fpdm}" />
 			   </li>
 				       			 			   <li><label>发票起始号码<b></b></label>
 			   <input  type="text" class="dfinput" id="fpqsh" name="skqFpj.fpqsh" placeholder="请输入发票起始号码" value="${ skqFpj.fpqsh}" />
 			   </li>
 				       			 			   <li><label>发票截止号码<b></b></label>
 			   <input  type="text" class="dfinput" id="fpjzh" name="skqFpj.fpjzh" placeholder="请输入发票截止号码" value="${ skqFpj.fpjzh}" />
 			   </li>
 				       			 			   <li><label>发票单位<b></b></label>
 			   <input  type="text" class="dfinput" id="fpdw" name="skqFpj.fpdw" placeholder="请输入发票单位" value="${ skqFpj.fpdw}" />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqFpj.nsrwjbm" placeholder="请输入纳税人微机编码" value="${ skqFpj.nsrwjbm}" />
 			   </li>
 				       			 			   <li><label>发票领购日期<b></b></label>
 			   <input  type="text" class="dfinput" id="fplgrq" name="skqFpj.fplgrq" placeholder="请输入发票领购日期" value="${ skqFpj.fplgrq}" />
 			   </li>
