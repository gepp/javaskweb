			       ...
			       <tr>
						<td><input type="checkbox" name="subBox" value="${item.id}" /></td>
															...
															${ item.cjsj}
						 													...
						 													<td>
							<a href="${ contextpath }/skqbdcmm/modify.htm?id=${item.id}" class="tablelink">编辑</a> 
							<a href="${ contextpath }/skqbdcmm/view.htm?id=${item.id}"  class="tablelink">查看</a>
 				   </tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqbdcmm/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqbdcmm","${ contextpath}/skqbdcmm/list?");
		});
</script>
