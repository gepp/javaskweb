...
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqBdcxmmxForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqBdcxmmx.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>子项目ID<b></b></label>
 			   <input  type="text" class="dfinput" id="parentid" name="skqBdcxmmx.parentid" placeholder="请输入子项目ID"  />
 			   </li>
 			   ...
 			   <input  type="text" class="dfinput" id="cjz" name="skqBdcxmmx.cjz" placeholder="请输入创建者"  />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="cjsj" name="skqBdcxmmx.cjsj" placeholder="请输入创建时间"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqBdcxmmx.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>主项目名称<b></b></label>
 			   <input  type="text" class="dfinput" id="zxmmc" name="skqBdcxmmx.zxmmc" placeholder="请输入主项目名称"  />
 			   </li>
