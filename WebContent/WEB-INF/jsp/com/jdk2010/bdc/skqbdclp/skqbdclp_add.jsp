...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">不动产楼盘添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqBdclpForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqBdclp.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>项目明细ID<b></b></label>
 			   <input  type="text" class="dfinput" id="parentid" name="skqBdclp.parentid" placeholder="请输入项目明细ID"  />
 			   </li>
 				       			 			   <li><label>楼牌号<b></b></label>
 			   <input  type="text" class="dfinput" id="lpmc" name="skqBdclp.lpmc" placeholder="请输入楼牌号"  />
 			   </li>
 				       			 			   <li><label>楼层<b></b></label>
 			   <input  type="text" class="dfinput" id="lc" name="skqBdclp.lc" placeholder="请输入楼层"  />
 			   </li>
 				       			 			   <li><label>楼牌序号<b></b></label>
 			   <input  type="text" class="dfinput" id="lpxh" name="skqBdclp.lpxh" placeholder="请输入楼牌序号"  />
 			   </li>
 				       			 			   <li><label>面积<b></b></label>
 			   <input  type="text" class="dfinput" id="mj" name="skqBdclp.mj" placeholder="请输入面积"  />
 			   </li>
 				       			 			   <li><label>单价<b></b></label>
 			   <input  type="text" class="dfinput" id="dj" name="skqBdclp.dj" placeholder="请输入单价"  />
 			   </li>
 				       			 			   <li><label>类型<b></b></label>
 			   <input  type="text" class="dfinput" id="lx" name="skqBdclp.lx" placeholder="请输入类型"  />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="cjsj" name="skqBdclp.cjsj" placeholder="请输入创建时间"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqBdclp.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>已开金额<b></b></label>
 			   <input  type="text" class="dfinput" id="ykje" name="skqBdclp.ykje" placeholder="请输入已开金额"  />
 			   </li>
 				       			 			   <li><label>状态<b></b></label>
 			   <input  type="text" class="dfinput" id="status" name="skqBdclp.status" placeholder="请输入状态"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqbdclp/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
