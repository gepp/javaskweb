			       ...
			       <tr>
						<td><input type="checkbox" name="subBox" value="${item.id}" /></td>
															...
															${ item.status}
						 													...
						 													<td>
							<a href="${ contextpath }/skqbdclp/modify.htm?id=${item.id}" class="tablelink">编辑</a> 
							<a href="${ contextpath }/skqbdclp/view.htm?id=${item.id}"  class="tablelink">查看</a>
 				   </tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqbdclp/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqbdclp","${ contextpath}/skqbdclp/list?");
		});
</script>
