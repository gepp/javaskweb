				...
				<c:forEach items="${pageList.list}" var="item">
			       ...
			       <tr>
						<td><input type="checkbox" name="subBox" value="${item.id}" /></td>
							...
							<a href="${ contextpath }/skqbdczxm/view.htm?id=${item.id}"  class="tablelink">查看</a>
 				   </tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqbdczxm/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqbdczxm","${ contextpath}/skqbdczxm/list?");
		});
</script>
