...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">不动产主项目编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="POST"  id="skqBdczxmForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqBdczxm.id" placeholder="请输入id" value="${ skqBdczxm.id}" />
 			   </li>
 				       			 			   <li><label>主项目ID<b></b></label>
 			   <input  type="text" class="dfinput" id="parentid" name="skqBdczxm.parentid" placeholder="请输入主项目ID" value="${ skqBdczxm.parentid}" />
 			   </li>
 				       			 			   <li><label>项目名称<b></b></label>
 			   <input  type="text" class="dfinput" id="xmmc" name="skqBdczxm.xmmc" placeholder="请输入项目名称" value="${ skqBdczxm.xmmc}" />
 			   </li>
 				       			 			   <li><label>税务机关编码<b></b></label>
 			   <input  type="text" class="dfinput" id="zgswjg" name="skqBdczxm.zgswjg" placeholder="请输入税务机关编码" value="${ skqBdczxm.zgswjg}" />
 			   </li>
 				       			 			   <li><label>创建者<b></b></label>
 			   <input  type="text" class="dfinput" id="cjz" name="skqBdczxm.cjz" placeholder="请输入创建者" value="${ skqBdczxm.cjz}" />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="cjsj" name="skqBdczxm.cjsj" placeholder="请输入创建时间" value="${ skqBdczxm.cjsj}" />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqBdczxm.nsrwjbm" placeholder="请输入纳税人微机编码" value="${ skqBdczxm.nsrwjbm}" />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url: "${ contextpath}/skqbdczxm/modifyaction",
 			            data: $(form).serialize(),
 			            type: "POST",
