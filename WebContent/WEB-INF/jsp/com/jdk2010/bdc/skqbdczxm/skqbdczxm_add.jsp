...
<div class="formbody">
   <div id="usual1" class="usual">
    <div class="itab">
       <ul>
        <li><a href="#tab1" class="selected">不动产子项目添加</a></li>
      </ul>
     </div>
       ...
       <ul class="forminfo">
        <form action="" method="POST"  id="skqBdczxmForm">
           <li>
            ...
            ${skqBdc.xmmc}-<input  type="text" class="dfinput" id="xmmc" name="skqBdczxm.xmmc" placeholder="请输入项目名称"  />
          </li>
           <li>
             <input  type="hidden" id="parentid" name="skqBdczxm.parentid" value="${bdcid}"  />
             <input  type="hidden" id="nsrwjbm" name="skqBdczxm.nsrwjbm" value="${nsrwjbm}"  />
             <input  type="hidden" id="bdcXmmc" name="bdcXmmc" value="${skqBdc.xmmc}"  />
            <label>&nbsp;</label>
            <input name="" type="submit" class="btn" value=" 确定"/>
            &nbsp;&nbsp;
            <input name="" type="button" class="btn" value="返回" onclick="window.location='${ contextpath}/skqbdczxm/list?nsrwjbm=${nsrwjbm}&bdcid=${bdcid}'"/>
          </li>
         </form>
      </ul>
     </div>
 			            ...
 			            success: function(data){
 			                ...
 			                if(data.status=='success'){
								...
								shade:0,closeBtn: 0
									...
									window.location.href='${ contextpath}/skqbdczxm/list?nsrwjbm=${nsrwjbm}&bdcid=${bdcid}';
								});
