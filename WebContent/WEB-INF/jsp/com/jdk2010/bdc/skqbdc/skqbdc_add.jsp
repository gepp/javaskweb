    ...
    <div id="tab1" class="tabson">
       <ul class="forminfo">
        <form action="" method="POST" id="skqBdcForm">
          ...
          <li>
            <input type="hidden" name="skqBdc.nsrwjbm" id="nsrwjbm" value="${nsrwjbm}" />
            <label>&nbsp;</label>
            <input name="" type="submit" class="btn" value=" 确定"/>
            &nbsp;&nbsp;
            <input name="" type="button" class="btn" value="返回" onclick="window.location='${ contextpath}/skqbdc/list?nsrwjbm=${nsrwjbm}'"/>
          </li>
         </form>
      </ul>
     </div>
 			            ...
 			            success: function(data){
 			                ...
 			                if(data.status=='success'){
								...
								shade:0,closeBtn: 0
									...
									window.location.href='${ contextpath}/skqbdc/list?nsrwjbm=${nsrwjbm}';
								});
