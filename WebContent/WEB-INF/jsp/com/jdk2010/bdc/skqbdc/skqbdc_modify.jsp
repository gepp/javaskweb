...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">不动产编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="POST"  id="skqBdcForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqBdc.id" placeholder="请输入id" value="${ skqBdc.id}" />
 			   </li>
 				       			 			   <li><label>项目名称<b></b></label>
 			   <input  type="text" class="dfinput" id="xmmc" name="skqBdc.xmmc" placeholder="请输入项目名称" value="${ skqBdc.xmmc}" />
 			   </li>
 				       			 			   <li><label>状态<b></b></label>
 			   <input  type="text" class="dfinput" id="status" name="skqBdc.status" placeholder="请输入状态" value="${ skqBdc.status}" />
 			   </li>
 				       			 			   <li><label>创建者<b></b></label>
 			   <input  type="text" class="dfinput" id="cjz" name="skqBdc.cjz" placeholder="请输入创建者" value="${ skqBdc.cjz}" />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="cjsj" name="skqBdc.cjsj" placeholder="请输入创建时间" value="${ skqBdc.cjsj}" />
 			   </li>
 				       			 			   <li><label>税务机关编码<b></b></label>
 			   <input  type="text" class="dfinput" id="swjgbm" name="skqBdc.swjgbm" placeholder="请输入税务机关编码" value="${ skqBdc.swjgbm}" />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqBdc.nsrwjbm" placeholder="请输入纳税人微机编码" value="${ skqBdc.nsrwjbm}" />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url: "${ contextpath}/skqbdc/modifyaction",
 			            data: $(form).serialize(),
 			            type: "POST",
