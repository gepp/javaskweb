			       ...
			       <tr>
						<td><input type="checkbox" name="subBox" value="${item.id}" /></td>
															...
															${ item.qybz}
						 													...
						 													<td>
							<a href="${ contextpath }/skqdhde/modify.htm?id=${item.id}" class="tablelink">编辑</a> 
							<a href="${ contextpath }/skqdhde/view.htm?id=${item.id}"  class="tablelink">查看</a>
 				   </tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqdhde/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqdhde","${ contextpath}/skqdhde/list?");
		});
</script>
