...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">单户定额调整添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqDhdeForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqDhde.id" placeholder="请输入ID"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqDhde.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>机器编号<b></b></label>
 			   <input  type="text" class="dfinput" id="jqbh" name="skqDhde.jqbh" placeholder="请输入机器编号"  />
 			   </li>
 				       			 			   <li><label>机器编号<b></b></label>
 			   <input  type="text" class="dfinput" id="dzkpxe" name="skqDhde.dzkpxe" placeholder="请输入机器编号"  />
 			   </li>
 				       			 			   <li><label>月累计开票限额<b></b></label>
 			   <input  type="text" class="dfinput" id="yljkpxe" name="skqDhde.yljkpxe" placeholder="请输入月累计开票限额"  />
 			   </li>
 				       			 			   <li><label>月累计开票限额<b></b></label>
 			   <input  type="text" class="dfinput" id="yljtpxe" name="skqDhde.yljtpxe" placeholder="请输入月累计开票限额"  />
 			   </li>
 				       			 			   <li><label>启用标示<b></b></label>
 			   <input  type="text" class="dfinput" id="qybz" name="skqDhde.qybz" placeholder="请输入启用标示"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqdhde/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
