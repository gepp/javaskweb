...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">品目变更添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqPmbgForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqPmbg.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqPmbg.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>机器编号<b></b></label>
 			   <input  type="text" class="dfinput" id="jqbh" name="skqPmbg.jqbh" placeholder="请输入机器编号"  />
 			   </li>
 				       			 			   <li><label>原税目编码<b></b></label>
 			   <input  type="text" class="dfinput" id="ysmbm" name="skqPmbg.ysmbm" placeholder="请输入原税目编码"  />
 			   </li>
 				       			 			   <li><label>变更税目编码<b></b></label>
 			   <input  type="text" class="dfinput" id="bgsmbm" name="skqPmbg.bgsmbm" placeholder="请输入变更税目编码"  />
 			   </li>
 				       			 			   <li><label>变更说明<b></b></label>
 			   <input  type="text" class="dfinput" id="bgsm" name="skqPmbg.bgsm" placeholder="请输入变更说明"  />
 			   </li>
 				       			 			   <li><label>申请时间<b></b></label>
 			   <input  type="text" class="dfinput" id="sqsj" name="skqPmbg.sqsj" placeholder="请输入申请时间"  />
 			   </li>
 				       			 			   <li><label>申请时间<b></b></label>
 			   <input  type="text" class="dfinput" id="clbz" name="skqPmbg.clbz" placeholder="请输入申请时间"  />
 			   </li>
 				       			 			   <li><label>处理者<b></b></label>
 			   <input  type="text" class="dfinput" id="clz" name="skqPmbg.clz" placeholder="请输入处理者"  />
 			   </li>
 				       			 			   <li><label>处理意见<b></b></label>
 			   <input  type="text" class="dfinput" id="clyj" name="skqPmbg.clyj" placeholder="请输入处理意见"  />
 			   </li>
 				       			 			   <li><label>处理意见<b></b></label>
 			   <input  type="text" class="dfinput" id="clsj" name="skqPmbg.clsj" placeholder="请输入处理意见"  />
 			   </li>
 				       			 			   <li><label>处理意见<b></b></label>
 			   <input  type="text" class="dfinput" id="xzbs" name="skqPmbg.xzbs" placeholder="请输入处理意见"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqpmbg/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
