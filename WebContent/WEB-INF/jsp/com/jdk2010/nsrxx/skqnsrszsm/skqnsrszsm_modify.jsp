...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">纳税人税种税目编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="POST"  id="skqNsrszsmForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqNsrszsm.id" placeholder="请输入id" value="${ skqNsrszsm.id}" />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqNsrszsm.nsrwjbm" placeholder="请输入纳税人微机编码" value="${ skqNsrszsm.nsrwjbm}" />
 			   </li>
 				       			 			   <li><label>税种编码<b></b></label>
 			   <input  type="text" class="dfinput" id="szbm" name="skqNsrszsm.szbm" placeholder="请输入税种编码" value="${ skqNsrszsm.szbm}" />
 			   </li>
 				       			 			   <li><label>税种编码<b></b></label>
 			   <input  type="text" class="dfinput" id="smbm" name="skqNsrszsm.smbm" placeholder="请输入税种编码" value="${ skqNsrszsm.smbm}" />
 			   </li>
 				       			 			   <li><label>税种编码<b></b></label>
 			   <input  type="text" class="dfinput" id="smmc" name="skqNsrszsm.smmc" placeholder="请输入税种编码" value="${ skqNsrszsm.smmc}" />
 			   </li>
 				       			 			   <li><label>税种编码<b></b></label>
 			   <input  type="text" class="dfinput" id="smjc" name="skqNsrszsm.smjc" placeholder="请输入税种编码" value="${ skqNsrszsm.smjc}" />
 			   </li>
 				       			 			   <li><label>税率<b></b></label>
 			   <input  type="text" class="dfinput" id="sl" name="skqNsrszsm.sl" placeholder="请输入税率" value="${ skqNsrszsm.sl}" />
 			   </li>
 				       			 			   <li><label>状态<b></b></label>
 			   <input  type="text" class="dfinput" id="status" name="skqNsrszsm.status" placeholder="请输入状态" value="${ skqNsrszsm.status}" />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url: "${ contextpath}/skqnsrszsm/modifyaction",
 			            data: $(form).serialize(),
 			            type: "POST",
