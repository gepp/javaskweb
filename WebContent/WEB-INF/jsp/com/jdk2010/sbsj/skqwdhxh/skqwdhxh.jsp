			       ...
			       <tr>
						<td><input type="checkbox" name="subBox" value="${item.id}" /></td>
															...
															${ item.wjbmxh}
						 													...
						 													<td>
							<a href="${ contextpath }/skqwdhxh/modify.htm?id=${item.id}" class="tablelink">编辑</a> 
							<a href="${ contextpath }/skqwdhxh/view.htm?id=${item.id}"  class="tablelink">查看</a>
 				   </tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqwdhxh/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqwdhxh","${ contextpath}/skqwdhxh/list?");
		});
</script>
