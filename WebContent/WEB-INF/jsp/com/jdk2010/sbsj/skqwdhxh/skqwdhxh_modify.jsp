...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">文档号序号编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="POST"  id="skqWdhxhForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqWdhxh.id" placeholder="请输入id" value="${ skqWdhxh.id}" />
 			   </li>
 				       			 			   <li><label>文档号序号<b></b></label>
 			   <input  type="text" class="dfinput" id="wdhxh" name="skqWdhxh.wdhxh" placeholder="请输入文档号序号" value="${ skqWdhxh.wdhxh}" />
 			   </li>
 				       			 			   <li><label>LSXH<b></b></label>
 			   <input  type="text" class="dfinput" id="lsxh" name="skqWdhxh.lsxh" placeholder="请输入LSXH" value="${ skqWdhxh.lsxh}" />
 			   </li>
 				       			 			   <li><label>WJBMXH<b></b></label>
 			   <input  type="text" class="dfinput" id="wjbmxh" name="skqWdhxh.wjbmxh" placeholder="请输入WJBMXH" value="${ skqWdhxh.wjbmxh}" />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url: "${ contextpath}/skqwdhxh/modifyaction",
 			            data: $(form).serialize(),
 			            type: "POST",
