...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">申报数据明细添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqSbsjmxForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqSbsjmx.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>申报数据ID<b></b></label>
 			   <input  type="text" class="dfinput" id="parentid" name="skqSbsjmx.parentid" placeholder="请输入申报数据ID"  />
 			   </li>
 				       			 			   <li><label>税目编码<b></b></label>
 			   <input  type="text" class="dfinput" id="smbm" name="skqSbsjmx.smbm" placeholder="请输入税目编码"  />
 			   </li>
 				       			 			   <li><label>金额<b></b></label>
 			   <input  type="text" class="dfinput" id="je" name="skqSbsjmx.je" placeholder="请输入金额"  />
 			   </li>
 				       			 			   <li><label>开票类型<b></b></label>
 			   <input  type="text" class="dfinput" id="kplx" name="skqSbsjmx.kplx" placeholder="请输入开票类型"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqsbsjmx/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
