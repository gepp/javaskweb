...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">汇总数据明细编辑</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  ...
  <form action="" method="POST"  id="skqHzsjmxForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqHzsjmx.id" placeholder="请输入id" value="${ skqHzsjmx.id}" />
 			   </li>
 				       			 			   <li><label>申报汇总ID<b></b></label>
 			   <input  type="text" class="dfinput" id="parentid" name="skqHzsjmx.parentid" placeholder="请输入申报汇总ID" value="${ skqHzsjmx.parentid}" />
 			   </li>
 				       			 			   <li><label>税目编码<b></b></label>
 			   <input  type="text" class="dfinput" id="smbm" name="skqHzsjmx.smbm" placeholder="请输入税目编码" value="${ skqHzsjmx.smbm}" />
 			   </li>
 				       			 			   <li><label>开票金额<b></b></label>
 			   <input  type="text" class="dfinput" id="kpje" name="skqHzsjmx.kpje" placeholder="请输入开票金额" value="${ skqHzsjmx.kpje}" />
 			   </li>
 				       			 			   <li><label>抵扣金额<b></b></label>
 			   <input  type="text" class="dfinput" id="dkje" name="skqHzsjmx.dkje" placeholder="请输入抵扣金额" value="${ skqHzsjmx.dkje}" />
 			   </li>
 				       			 			   <li><label>月核定营业额<b></b></label>
 			   <input  type="text" class="dfinput" id="yhdyye" name="skqHzsjmx.yhdyye" placeholder="请输入月核定营业额" value="${ skqHzsjmx.yhdyye}" />
 			   </li>
 				       			 			   <li><label>标示<b></b></label>
 			   <input  type="text" class="dfinput" id="flag" name="skqHzsjmx.flag" placeholder="请输入标示" value="${ skqHzsjmx.flag}" />
 			   </li>
 				       			 			   <li><label>申报金额<b></b></label>
 			   <input  type="text" class="dfinput" id="sbje" name="skqHzsjmx.sbje" placeholder="请输入申报金额" value="${ skqHzsjmx.sbje}" />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url: "${ contextpath}/skqhzsjmx/modifyaction",
 			            data: $(form).serialize(),
 			            type: "POST",
