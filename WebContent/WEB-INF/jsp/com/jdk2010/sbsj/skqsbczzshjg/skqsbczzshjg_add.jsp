...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">申报查账征收户异常警告添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqSbczzshjgForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqSbczzshjg.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqSbczzshjg.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>年份<b></b></label>
 			   <input  type="text" class="dfinput" id="year" name="skqSbczzshjg.year" placeholder="请输入年份"  />
 			   </li>
 				       			 			   <li><label>月份<b></b></label>
 			   <input  type="text" class="dfinput" id="month" name="skqSbczzshjg.month" placeholder="请输入月份"  />
 			   </li>
 				       			 			   <li><label>开票税款<b></b></label>
 			   <input  type="text" class="dfinput" id="kpsk" name="skqSbczzshjg.kpsk" placeholder="请输入开票税款"  />
 			   </li>
 				       			 			   <li><label>申报税款<b></b></label>
 			   <input  type="text" class="dfinput" id="sbsk" name="skqSbczzshjg.sbsk" placeholder="请输入申报税款"  />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="clbz" name="skqSbczzshjg.clbz" placeholder="请输入创建时间"  />
 			   </li>
 				       			 			   <li><label>处理标示<b></b></label>
 			   <input  type="text" class="dfinput" id="cjsj" name="skqSbczzshjg.cjsj" placeholder="请输入处理标示"  />
 			   </li>
 				       			 			   <li><label>处理时间<b></b></label>
 			   <input  type="text" class="dfinput" id="clsj" name="skqSbczzshjg.clsj" placeholder="请输入处理时间"  />
 			   </li>
 				       			 			   <li><label>处理者<b></b></label>
 			   <input  type="text" class="dfinput" id="clz" name="skqSbczzshjg.clz" placeholder="请输入处理者"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqsbczzshjg/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
