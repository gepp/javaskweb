...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">申报核定户异常警告添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqSbhdhjgForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqSbhdhjg.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqSbhdhjg.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>年份<b></b></label>
 			   <input  type="text" class="dfinput" id="year" name="skqSbhdhjg.year" placeholder="请输入年份"  />
 			   </li>
 				       			 			   <li><label>月份<b></b></label>
 			   <input  type="text" class="dfinput" id="month" name="skqSbhdhjg.month" placeholder="请输入月份"  />
 			   </li>
 				       			 			   <li><label>创建时间<b></b></label>
 			   <input  type="text" class="dfinput" id="cjsj" name="skqSbhdhjg.cjsj" placeholder="请输入创建时间"  />
 			   </li>
 				       			 			   <li><label>处理标示<b></b></label>
 			   <input  type="text" class="dfinput" id="clbz" name="skqSbhdhjg.clbz" placeholder="请输入处理标示"  />
 			   </li>
 				       			 			   <li><label>处理时间<b></b></label>
 			   <input  type="text" class="dfinput" id="clz" name="skqSbhdhjg.clz" placeholder="请输入处理时间"  />
 			   </li>
 				       			 			   <li><label>处理者<b></b></label>
 			   <input  type="text" class="dfinput" id="clsj" name="skqSbhdhjg.clsj" placeholder="请输入处理者"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqsbhdhjg/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
