...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">监控数据下载控制添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqJksjkzForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqJksjkz.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>纳税人微机编码<b></b></label>
 			   <input  type="text" class="dfinput" id="nsrwjbm" name="skqJksjkz.nsrwjbm" placeholder="请输入纳税人微机编码"  />
 			   </li>
 				       			 			   <li><label>原因<b></b></label>
 			   <input  type="text" class="dfinput" id="tzyy" name="skqJksjkz.tzyy" placeholder="请输入原因"  />
 			   </li>
 				       			 			   <li><label>限制时间<b></b></label>
 			   <input  type="text" class="dfinput" id="tzsj" name="skqJksjkz.tzsj" placeholder="请输入限制时间"  />
 			   </li>
 				       			 			   <li><label>创建者<b></b></label>
 			   <input  type="text" class="dfinput" id="cjz" name="skqJksjkz.cjz" placeholder="请输入创建者"  />
 			   </li>
 				       			 			   <li><label>状态<b></b></label>
 			   <input  type="text" class="dfinput" id="status" name="skqJksjkz.status" placeholder="请输入状态"  />
 			   </li>
 				       			 			   <li><label>开放时间<b></b></label>
 			   <input  type="text" class="dfinput" id="kfsj" name="skqJksjkz.kfsj" placeholder="请输入开放时间"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqjksjkz/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
