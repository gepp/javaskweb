			       ...
			       <tr>
						<td><input type="checkbox" name="subBox" value="${item.id}" /></td>
															...
															${ item.kfsj}
						 													...
						 													<td>
							<a href="${ contextpath }/skqjksjkz/modify.htm?id=${item.id}" class="tablelink">编辑</a> 
							<a href="${ contextpath }/skqjksjkz/view.htm?id=${item.id}"  class="tablelink">查看</a>
 				   </tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqjksjkz/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqjksjkz","${ contextpath}/skqjksjkz/list?");
		});
</script>
