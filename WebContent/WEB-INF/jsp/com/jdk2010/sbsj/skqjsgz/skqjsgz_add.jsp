...
<div id="usual1" class="usual"> 
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">计税规则添加</a></li> 
  	</ul>
</div> 
<div id="tab1" class="tabson">
  <ul class="forminfo">
  	<form action="" method="POST"  id="skqJsgzForm">
 			   ...
 			   <input  type="text" class="dfinput" id="id" name="skqJsgz.id" placeholder="请输入id"  />
 			   </li>
 				       			 			   <li><label>税务机关编码<b></b></label>
 			   <input  type="text" class="dfinput" id="swjgbm" name="skqJsgz.swjgbm" placeholder="请输入税务机关编码"  />
 			   </li>
 				       			 			   <li><label>税目编码<b></b></label>
 			   <input  type="text" class="dfinput" id="smbm" name="skqJsgz.smbm" placeholder="请输入税目编码"  />
 			   </li>
 				       			 			   <li><label>税目简称<b></b></label>
 			   <input  type="text" class="dfinput" id="smjc" name="skqJsgz.smjc" placeholder="请输入税目简称"  />
 			   </li>
 				       			 			   <li><label>特征标示<b></b></label>
 			   <input  type="text" class="dfinput" id="tzbs" name="skqJsgz.tzbs" placeholder="请输入特征标示"  />
 			   </li>
 				       			 			   <li><label>计税规则<b></b></label>
 			   <input  type="text" class="dfinput" id="jsgz" name="skqJsgz.jsgz" placeholder="请输入计税规则"  />
 			   </li>
 				       			 			   <li><label>启用标示<b></b></label>
 			   <input  type="text" class="dfinput" id="qybj" name="skqJsgz.qybj" placeholder="请输入启用标示"  />
 			   </li>
 			...
 			.validator({
 			   ...
 			   valid: function(form){
 				  var me = this;
 			        ...
 			        me.holdSubmit();
 			        $.ajax({
 			            url:"${ contextpath}/skqjsgz/addaction",
 			            data: $(form).serialize(),
 			            type: "POST",
