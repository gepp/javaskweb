...
<body>
	...
	<div class="formbody">
		<div id="usual1" class="usual">
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">注册类型编辑</a></li>
				</ul>
			</div>
								...
								.validator(
										{
											...
											valid : function(form) {
												...
												$
														.ajax({
															url : "${ contextpath}/skqzclx/modifyaction",
															data : $(form)
																	.serialize(),
															type : "POST",
															success : function(
