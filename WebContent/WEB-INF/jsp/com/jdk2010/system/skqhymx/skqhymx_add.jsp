				...
				<ul class="forminfo">
					<form action="" method="POST" id="skqHymxForm">
						...
						<li><label>&nbsp;</label><input name="" type="submit"
							...
							onclick="window.location='${ contextpath}/skqhymx/list'" /></li>
					</form>
				</ul>
			</div>
		</div>
																...
																if (data.status == 'success') {
																	...
																	layer
																			.alert(
																					...
																					function() {
																						window.location.href = '${ contextpath}/skqhymx/list.htm?hyId=${hyId}';
																					});
