...
<body>
	...
	<div class="formbody">
		<div id="usual1" class="usual">
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">品目设置编辑</a></li>
				</ul>
			</div>
				...
				<ul class="forminfo">
					<form action="" method="POST" id="skqPmszForm">
						...
						<li><label>票种编码<b></b></label> <input type="text"
							...
							value="${skqPmsz.fpbm }" readonly onclick="selectFp();" /> <input
							type="button" value="选择票种" onclick="selectFp();" class="btn" /></li>
						...
						<li><label>状态<b></b></label>
							<div class="vocation">
								<select name="skqPmsz.status" class="select1">
									<option value="0"
										<c:if test="${skqPmsz.status==0}">selected</c:if>>停用</option>
									<option value="1"
										<c:if test="${skqPmsz.status==1}">selected</c:if>>启用</option>
								</select>
							</div></li>
