			...
			<tbody>
				<c:forEach items="${pageList.list}" var="item">
					...
					<tr>
						...
						<td><a href="${ contextpath }/skqfp/modify.htm?id=${item.id}"
							class="tablelink">编辑</a> <a
							href="${ contextpath }/skqfp/view.htm?id=${item.id}"
							class="tablelink">查看</a>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		<page:page href="${ contextpath}/skqfp/list?" data="pageList" />
...
<script type="text/javascript">
		...
		$(document).ready(function(){
			table_init("${ contextpath}/skqfp","${ contextpath}/skqfp/list?");
		});
</script>
