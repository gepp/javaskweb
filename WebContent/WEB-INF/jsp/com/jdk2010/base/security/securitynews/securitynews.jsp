...
<body>
	...
	<form method="post" action="${ contextpath}/securitynews/list">
			...
			<li><label>通告标题</label><input type="text" name="title"
					id="title" class="scinput1" placeholder="请输入通告标题" value="${title}"></li>
			</ul>
			<div style="align: center; margin-bottom: 20px">
				...
				<ul class="seachform" style="left: 35%; position: absolute;">
					...
					<input name="" type="button"
						class="scbtn1" id="table_add" onclick="deleteInput();" value="新增" />
					<input name="" type="button"
					id="table_delete"
						class="scbtn2" onclick="deleteInput();" value="删除" />	
						</li>
					<li><label>&nbsp;</label></li>
		...
		<page:page href="${ contextpath}/securitynews/list?title=${title}"
			data="pageList" />
