...
<body>
	...
	<div class="formbody">
		<div id="usual1" class="usual">
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">税务机关编辑</a></li>
				</ul>
			</div>
				...
				<ul class="forminfo">
					<form action="" method="post" id="securityOrganizationForm">
					 <input type="hidden" class="dfinput" id="id" name="securityOrganization.id" placeholder="请输入pk" value="${ securityOrganization.id}" />
						...
						<li><label>税务机关简称<b></b></label> <input type="text" class="dfinput" id="description" name="securityOrganization.description" placeholder="请输入税务机关简称" value="${ securityOrganization.description}" /></li>
						<li><label>上级税务机关<b></b></label> <input type="hidden" class="dfinput" id="parentId" name="securityOrganization.parentId" placeholder="" value="${ securityOrganization.parentId}" "  /> <input type="text" class="dfinput" id="parentName" name="parentName" placeholder="" readonly
							value="${parentName }" /> <input type="button" value="选择上级" onclick="selectParentOrganization();" class="btn" /></li>
