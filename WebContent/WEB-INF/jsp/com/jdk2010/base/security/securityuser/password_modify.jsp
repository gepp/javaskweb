			...
			<div id="tab1" class="tabson">
				<ul class="forminfo">
					<form action="" method="post" id="securityUserForm">
						...
						<li><label>密码<b></b></label> <input type="password" class="dfinput" id="userpwd1" name="userpwd1"  placeholder="请输入密码" value="" /></li>
						<li><label>重复密码<b></b></label> <input type="password" class="dfinput" id="userpwd2" name="userpwd2"  placeholder="请再输入一遍密码" value="" /></li>
