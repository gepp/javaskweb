...
<body>
	...
	<div class="rightinfo">
		<ul class="seachform1">
			<li class="sarchbtn"><label>&nbsp;</label> <input name="" type="button" class="scbtn1" value="新增 " id="table_add" /> <input name="" type="submit" class="scbtn" value="查询" id="table_refresh" /> <input name="" type="button" class="scbtn2" value="批量删除" id="table_delete" /></li>
		</ul>
