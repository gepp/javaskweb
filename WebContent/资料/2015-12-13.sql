...
CREATE TABLE `skq_fpj` (
  ...
  `SWJGBM` varchar(30) DEFAULT NULL COMMENT '税务机关编码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert  into `skq_fpjmx`(`ID`,`NSRWJBM`,`FPBM`,`FPDM`,`FPQSH`,`FPJZH`,`FPDW`,`JQBH`,`FPXFZT`,`FPLGZT`,`MXSCZT`,`FPLGRQ`) values (1,'3204820824324234','001','132000000001',1,200,100,'123456',0,0,0,'2015-10-12 00:00:00'),(2,'3204820824324234','001','132000000001',201,400,100,'123456',0,0,0,'2015-10-12 00:00:00'),(3,'3204820824324234','001','132000000001',401,600,100,'123456',0,0,0,'2015-10-12 00:00:00');
...
insert  into `skq_jqszsm`(`id`,`JQBH`,`SMBM`) values (6,'1','10000001'),(7,'1','00000004'),(8,'123456','10000001'),(9,'123456','00000004'),(12,'12345','10000001'),(13,'12345','00000004');
...
insert  into `skq_jqxx`(`id`,`NSRWJBM`,`JQXHBM`,`JQBH`,`SKKH`,`YHKH`,`KQYRQ`,`KYXRQ`,`SBFS`,`MXSBBZ`,`KPJZRQ`,`DZKPXE`,`YLJKPXE`,`YLJTPXE`,`STATUS`) values (1,'3204820824324234','DT0002','12345','12345','12345','2015-09-10 00:00:00','2015-09-10 00:00:00','1','1','2015-09-10 00:00:00','1.00','234.00','1.00',1),(2,'3204820824324234','DT0001','123456','123456','123456','2015-12-12 00:00:00','2015-12-12 00:00:00','1','1','2015-12-12 00:00:00','1.00','1.00','1.00',1);
...
CREATE TABLE `skq_nsrxx` (
  ...
  `STATUS` int(11) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_NSRWJBM` (`NSRWJBM`)
